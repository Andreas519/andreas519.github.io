...
# Ordner, in dem start.py liegt
BASE_DIR = Path(__file__).resolve().parent

# Unterordner mit DobotDllType.py und den DLL-Dateien
...
# Erst jetzt darf DobotDllType importiert werden
...
def main():
    ...
    try:
        # Geschwindigkeit und Beschleunigung auf 20 % setzen
...
# ------x---------------------------------------------------
        # Eigenes Roboterprogramm laden
        import mein_test

        # Eigenes Roboterprogramm ausführen
        #mein_programm.beispiel_01(api, dType)
        #mein_programm.test(api, dType)
        mein_test.test(api, dType)
        
        # mein_programm.ausfuehren(api, dType)
        # mein_programm.SetHOMECmd(api, dType)
# ----------------------------------------------------------
