...
# eingefügte Alarmbehandlung
        alarmdaten = dType.GetAlarmsState(api)

        # Das erste Element enthält das Byte-Array mit den Alarmbits.
        ...
        if bewegungsindex <= aktueller_index and bewegungsindex not in angezeigte_befehle:
