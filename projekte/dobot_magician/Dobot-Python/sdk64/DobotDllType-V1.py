...
VERSION = "1.0.0"
VERSIONSDATUM = "19.07.2026"

# Übliche Python-Schreibweise für eine Modulversion.
__version__ = VERSION


def version():
    """Gibt die Version dieser Datei DobotDllType.py zurück."""

    return (
        f"DobotDllType.py Version {VERSION} "
        f"- Stand {VERSIONSDATUM}"
    )
