...
zusammen mit der anschließenden Wartezeit angezeigt.
"""
...
# ├── sdk64/
# └── projektordner/
#     ├── befehlskette_v2_5.py
#     └── befehlskette_beispiel_v2.5.py
...
def _befehl_vor_ausfuehrung_anzeigen(
    ...
    Zusätzlich wird die Wartezeit angezeigt, die nach diesem
    Bewegungsbefehl in der Queue ausgeführt wird.
    """
    ...
    if pause_ms > 0:
        wartezeit_text = (
            f"Wartezeit danach: {pause_ms} ms"
        )
    else:
        wartezeit_text = "Keine Wartezeit danach"
