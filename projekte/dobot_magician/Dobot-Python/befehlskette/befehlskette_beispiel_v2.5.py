"""Testprogramm für befehlskette_v2_5.py, Version 2.5.

Änderung gegenüber Version 2.4:
Beim nächsten Bewegungsbefehl wird zusätzlich die Wartezeit
angezeigt, die nach diesem Befehl ausgeführt wird.
"""
...
if ERWARTETE_VERSION == VERSION:
    print(f"Korrekte Version {VERSION} wird verwendet.")
else:
    print(
        f"Versionskonflikt: erwartet {ERWARTETE_VERSION}, "
        f"geladen {VERSION}."
    )
    sys.exit()
