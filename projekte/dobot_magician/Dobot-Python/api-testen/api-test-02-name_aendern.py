...
2. fragt nach einem neuen Gerätenamen,
3. speichert den neuen Namen,
4. liest den Gerätenamen erneut.
Dobot Magician - AG Young Engineers - Martin-Rinckart-Gymnasium
"""
...
try:
    ...
    neuer_name = input("Neuer Gerätename: ").strip()

    if not neuer_name:
        print("Der Name wurde nicht geändert.")
    else:
        dType.SetDeviceName(api, neuer_name)
        dType.dSleep(200)

        gespeicherter_name = dType.GetDeviceName(api)

        print()
        print("Gerätename nach der Änderung:")
        print(gespeicherter_name)
