...
Schaltet den Sauger über die Queue ein und anschließend wieder aus.
"""
...
try:
    ...
    print("Sauger wird über die Queue aktiviert.")

    index_an = dType.SetEndEffectorSuctionCup(
        api,
        True,
        True,
        isQueued=1,
    ...
    status_an = bool(
        dType.GetEndEffectorSuctionCup(api)[0]
    )

    print("Saugerstatus:", status_an)

    input(
        "Sauger beobachten und zum Ausschalten Enter drücken: "
    )

    print("Sauger wird über die Queue deaktiviert.")

    index_aus = dType.SetEndEffectorSuctionCup(
        api,
        True,
        False,
        isQueued=1,
    ...
    print("Saugerstatus:", status_aus)

finally:
    if verbunden:
        # Sauger vorsichtshalber sofort ausschalten.
