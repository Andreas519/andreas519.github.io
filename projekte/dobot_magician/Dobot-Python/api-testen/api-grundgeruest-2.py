...
# Bereich für deinen Programmcode ...
    dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, 180, 160, 50, 0, isQueued=1, )[0]
    dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, 240, 140, 50, 0, isQueued=1, )[0]
    dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, 200, 180, 50, 0, isQueued=1, )[0]
