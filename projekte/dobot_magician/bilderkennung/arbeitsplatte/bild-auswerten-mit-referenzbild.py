...
hintergrund_orginal = cv2.imread(
    "bilder/arbeitsplatte_leer.png"
)
hintergrund = cv2.resize(hintergrund_orginal, None, fx=0.15, fy=0.15, interpolation=cv2.INTER_AREA )

bild_orginal = cv2.imread(
    "bilder/arbeitsplatte.png"
)
bild = cv2.resize(bild_orginal, None, fx=0.15, fy=0.15, interpolation=cv2.INTER_AREA )
