...
bereichsmaske = np.full((hoehe, breite), 255, dtype=np.uint8 )
# einzelne Bereiche ausschließen
cv2.rectangle( bereichsmaske, ( 100, 150), (200, hoehe), 0, -1 )
#cv2.rectangle( bereichsmaske, ( 10, 10), (100, 270), 0, -1 )
#cv2.rectangle( bereichsmaske, (385, 10), (285, 270), 0, -1 )
...
cv2.imshow("Überlagerung", ueberlagerung)
cv2.imshow("Maske", maske)
cv2.imshow("Original", bild)


anzeige = cv2.addWeighted(bild, 0.65, ueberlagerung, 0.15, 0)
