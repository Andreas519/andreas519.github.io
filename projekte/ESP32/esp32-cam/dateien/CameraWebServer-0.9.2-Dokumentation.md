# ESP32-CAM CameraWebServer 0.9.2

## Überblick

Version 0.9.2 ergänzt den direkten Wechsel vom BLE- in den Access-Point-Modus.
Die IP-Adresse des eigenen ESP32-CAM-WLANs ist dabei wählbar und bleibt im
NVS-Flash gespeichert. Dadurch können in der AG mehrere Module mit getrennten
Adressbereichen betrieben werden.
...
```text
Version:           0.9.2
Programmspeicher:  1.861.676 von 3.145.728 Byte (59 %)
Globale Variablen: 86.784 von 327.680 Byte (26 %)
```
