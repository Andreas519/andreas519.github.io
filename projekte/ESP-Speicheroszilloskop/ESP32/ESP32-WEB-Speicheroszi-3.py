    ...
    while True:
        ...
        if trigger_mode == "rising":
            if wert >= trigger_level:
                print("Trigger durch Ueberschreiten ausgeloest:", wert)
                return True, wert

        elif trigger_mode == "falling":
            if wert <= trigger_level:
                print("Trigger durch Unterschreiten ausgeloest:", wert)
                return True, wert
...
<div class="box">
    ...
    <p>
        ...
        <select id="triggermode">
            ...
            <option value="rising">Ueberschreiten</option>
            <option value="falling">Unterschreiten</option>
        </select>
    </p>

    <p class="hinweis">
        ADC-Bereich: 0 bis 4095. Bei Triggerart "Ueberschreiten" startet die Messung bei ADC >= Triggerlevel.
        Bei "Unterschreiten" startet sie bei ADC <= Triggerlevel.
    </p>
